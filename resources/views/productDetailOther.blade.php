...
<body>
  <div class="container-fluid">
    ...
    <div class="main-content">
      <div class="main-foto"><img src="/storage/{{ $OtherProduct->FotoOther }}" alt="{{ $OtherProduct->FotoOther }}"></div>
      
      <div class="details-container">
        <div class="first-line">
          <div><h3 id="product-name">{{ $OtherProduct->NamaOther }}</h3></div>
          <div><del>{{ $OtherProduct->DiskonOther }}</del></div>
          <div class="harga">{{ $OtherProduct->HargaOther }}</div>
        </div>
        <div class="second-line">
          <div class="description">{{ $OtherProduct->DescriptionOther }}
          </div>
        </div>
        <div class="third-line">
          <div class="plus-minus">
            <button onclick="minus()" class="minus-btn" id="minus">-</button>
            <div class="showNumber" id="showNumber">1</div>
