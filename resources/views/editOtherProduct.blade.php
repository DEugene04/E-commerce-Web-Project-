...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <h1 class="title">Edit Other Product</h1>


      <form action="/update-other-product/{{ $OtherProduct->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('patch')
        <div class="foto-box">
          <div class="bigBox-container">
            
            <div class="bigBox-1"><label for="FotoOther" class="form-label"><i class="fa-solid fa-pencil"></i></label></div>
            @error('FotoOther')
        ...
        <div class="mb-3">
          ...
          <input type="file" class="form-control foto-input" id="FotoOther" aria-describedby="emailHelp" value="{{ $OtherProduct->FotoOther }}" name="FotoOther">
          
        <table>
          <tr>
            <td><label for="HargaOther" class="form-label">Harga</label></td>
            <td><input type="text" class="form-control w-100"   id="HargaOther" aria-describedby="emailHelp" value="{{ $OtherProduct->HargaOther }}" name="HargaOther">
            @error('HargaOther')
              <p style="color: red">{{ $message }}</p>
            @enderror</td>
          </tr>
          <tr>
            ...
            <td><input type="text" class="form-control w-100" id="NamaOther" aria-describedby="emailHelp" value="{{ $OtherProduct->NamaOther }}" name="NamaOther">
            @error('NamaOther')
              <p style="color: red">{{ $message }}</p>
            @enderror</td>
          </tr>
          <tr>
            ...
            <td><input type="text" class="form-control w-100" id="DescriptionOther" aria-describedby="emailHelp" value="{{ $OtherProduct->DescriptionOther }}" name="DescriptionOther">
        ...
        <button type="submit" class="btn btn-primary w-100 add-button">Edit</button>
      </form>
