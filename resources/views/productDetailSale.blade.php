...
<body>
  <div class="container-fluid">
    ...
    <div class="main-content">
      <div class="main-foto"><img src="/storage/{{ $sale->Foto }}" alt="{{ $sale->Foto }}"></div>
      
      <div class="details-container">
        <div class="first-line">
          <div><h3 id="product-name">{{ $sale->Nama }}</h3></div>
          <div><del>{{ $sale->Diskon }}</del></div>
          <div class="harga">{{ $sale->Harga }}</div>
        </div>
        <div class="second-line">
          <div class="description">{{ $sale->Description }}
          </div>
        </div>
