...
<html lang="en">
  <head>
    ...
    <title>Edit On Sale Product</title>
  ...
  <body>
    <div class="container">
      ...
      <h1 class="title">Edit On Sale Product</h1>


      <form action="/update-baju/{{ $sale->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('patch')
        <div class="foto-box">
        ...
        <div class="mb-3">
          ...
          <input type="file" class="form-control foto-input" id="Foto" aria-describedby="emailHelp" value="{{ $sale->Foto }}" name="Foto">
          
        <table>
          <tr>
            <td><label for="Harga" class="form-label">Harga</label></td>
            <td><input type="text" class="form-control w-100"   id="Harga" aria-describedby="emailHelp" value="{{ $sale->Harga }}" name="Harga">
            @error('Harga')
              <p style="color: red">{{ $message }}</p>
            @enderror</td>
          </tr>
          <tr>
            <td><label for="Diskon" class="form-label">Discount</label></td>
            <td><input type="text" class="form-control w-100"   id="Diskon" aria-describedby="emailHelp" value="{{ $sale->Diskon }}" name="Diskon">
            @error('Diskon')
              <p style="color: red">{{ $message }}</p>
            @enderror</td>
          </tr>
          <tr>
            ...
            <td><input type="text" class="form-control w-100" id="Nama" aria-describedby="emailHelp" value="{{ $sale->Nama }}" name="Nama">
            @error('Nama')
              <p style="color: red">{{ $message }}</p>
            @enderror</td>
          </tr>
          <tr>
            ...
            <td><input type="text" class="form-control w-100" id="Description" aria-describedby="emailHelp" value="{{ $sale->Description }}" name="Description">
            @error('Description')
              <p style="color: red">{{ $message }}</p>
            @enderror</td>
          </tr>
